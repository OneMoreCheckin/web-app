...
Omc.Widgets = new (function(){
	...
	// Gutting in progress!!! 
	this.mapper = function(cat, venues){
...
// venues -> century club -> [ids]
	...
	var BadgeList = new (function () {
		...
		this.add = function (obj) {
			...
			var onc = "Omc.Widgets.mapper('" + obj.cat.pop() + "', '" + (obj.venues ? obj.venues.pop() : '') + "');";
			$("#list_badges").append('<li onclick="' + onc + '" class="box_badge" id="id_box_badge'+cnt+'"><div class="img_badge"><img src="'+
				...
				' </p> </div><div class="pourcent_badge"><script>$(document).ready(function() {$("#progressbar'+
